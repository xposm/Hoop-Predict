...
// Define consistent timing constants
...
const preloadSecondTeam = () => {
  return import('./secondTeam');
};
...
export default function FirstTeam() {
    ...
    useEffect(() => {
        const timer = setTimeout(() => {
            preloadSecondTeam()
                .then(() => {
                    console.log('SecondTeam preloaded successfully');
                })
                .catch((error) => {
                    console.log('SecondTeam preload failed:', error);
                });
        }, 1000);
    ...
    return (
        <motion.div
            // Fixed viewport height with no overflow
        ...
        >
            <div className="flex flex-col flex-1 items-center justify-center gap-12 px-4">
                ...
                {/* Title with perfectly timed upward exit */}
                <motion.div
                ...
                {/* SearchBar with perfectly timed leftward exit */}
                <motion.div
